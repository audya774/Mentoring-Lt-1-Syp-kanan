  ...
  return (
    <>
      ...
      <div className="flex justify-between relative top-3 hidden lg:flex">
        <div>
          <img src="/LogoAsramaUSK.jpg" className="w-12 h-12 rounded-full" alt="Logo Asrama" />
        </div>
        <ul className="mt-2 flex gap-5">
          ...
          <li className="mb-4">
            <a href="#DaftarAnggota" className="text-white opacity-80 text-[1rem] font-semibold">
              Daftar Anggota
            </a>
          </li>
        </ul>
